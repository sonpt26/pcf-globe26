...
Results show ZSR$=$0.96, meaning instant adaptation achieves 96\% of dedicated-training quality across all test preferences.
...
GPI adaptation (blue) achieves 96\% of oracle quality (brown) from episode~0---a dot-product computation taking ${<}5$\,ms.
